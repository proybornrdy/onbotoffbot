...
public class TutorialStateMachine : MonoBehaviour {
	...
	void Awake () {
        ...
        states[TutorialState.Jump].Buttons.Add(new XboxButton("Xbox Buttons/xbox_a", new Vector2(183F, 17F), new Vector2(15F, 15F)));
        ...
        states[TutorialState.InteractOn].Buttons.Add(new XboxButton("Xbox Buttons/xbox_lb", new Vector2(31F, 17F), new Vector2(30F, 15F)));
        ...
        states[TutorialState.InteractOff].Buttons.Add(new XboxButton("Xbox Buttons/xbox_rb", new Vector2(47F, 17F), new Vector2(30F, 15F)));
        ...
        states[TutorialState.PickUpItem].Buttons.Add(new XboxButton("Xbox Buttons/xbox_b", new Vector2(54F, 17F), new Vector2(15F, 15F)));
